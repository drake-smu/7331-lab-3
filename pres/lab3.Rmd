...
Next lets get rid of some columns we are not going to use/that has some issues, look at some of the NA values, then break down our numeric variables into factors using `cut`
