...
After our first attempt at mining for rules, we're going to relax our support to 0.1 and increase our confidence to see what we get.  Aftewards, we'll target small and large incomes individually in order to see if we can isolate the itemsets that are going to be of highest influence. 
